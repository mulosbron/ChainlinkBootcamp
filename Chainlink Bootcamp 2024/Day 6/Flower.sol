...
contract Flower is ERC721, ERC721URIStorage, AutomationCompatibleInterface {
   ...
   // IPFS üzerindeki Metadata'ların linkleri.
    string[] IpfsUri = [
    ...
    constructor(uint updateInterval) ERC721("Cicek Bootcamp 2024", "CICEK") {
    ...
    // Çiçeğimizin büyümesi hangi aşamada?
    ...
    // Chainlink node'ları her blokta buradaki koşulu kontrol ediyor.
    ...
    //Chainlink node'ları koşul gerçekleştiği zaman gerekli fonksiyonu (growFlower) çağrıyor.
