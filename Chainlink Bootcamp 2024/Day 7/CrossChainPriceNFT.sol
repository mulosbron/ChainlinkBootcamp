...
contract CrossChainPriceNFT is ERC721, ERC721URIStorage {
    ...
    constructor() ERC721("CrossChain Turkey Price", "CCTRPrice") {
        chain[0] = ChainStruct ({
    ...
    function mintFrom(address to, uint256 sourceId) public {
        // sourceId 0 Sepolia, 1 Fuji, 2 Bnb testnet.
    ...
    function updateMetaData(uint256 tokenId, uint256 sourceId) public {
        ...
        string memory json = Base64.encode(
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Cross-chain Turkey Price SVG",',
                        '"description": "SVG Turkey NFTs in different chains",',
